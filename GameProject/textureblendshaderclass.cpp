...
TextureBlendShaderClass::TextureBlendShaderClass()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
TextureBlendShaderClass::TextureBlendShaderClass(const TextureBlendShaderClass& other)
{
}
...
bool TextureBlendShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"./data/texture_blend.vs", L"./data/texture_blend.ps");
	if(!result)
	{
		return false;
	}
...
void TextureBlendShaderClass::Shutdown()
{
...
bool TextureBlendShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
...
bool TextureBlendShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd,
...
void TextureBlendShaderClass::ShutdownShader()
{
...
void TextureBlendShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd,
...
bool TextureBlendShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
											 XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
...
void TextureBlendShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
